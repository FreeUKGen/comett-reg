<?php $session = session(); ?>    
	...
	if ( $session->masquerade == 1 )
		...
		<?php
				...
				<a class="" title="Signout" href="/home/signout/"><i class="fa-solid fa-door-open"></i></a>
				<a class="" title="Transcribe Home" href="<?=(base_url('transcribe/transcribe_step1/0')) ?>"><i class="fa-solid fa-house-user"></i></a>
				<a class="" title="Manage your Identity" href="<?=(base_url('identity/change_details_step2/0')) ?>"><i class="fa-solid fa-id-card"></i></a>
				<a class="" title="Housekeeping" href="/housekeeping/index/0"><i class="fa-solid fa-warehouse"></i></a>
				<?php
				switch ( $session->current_project[0]['project_index'] )
					{
						case 1: ?>
							<a class="" title="FreeBMD FAQ" href="https://www.freebmd.org.uk/vol_faq.html" target="_blank"><i class="fa-regular fa-circle-question"></i></a>
							<?php
							break;
						case 2: ?>
							<a class="" title="FreeREG FAQ" href="https://www.freereg.org.uk/cms/information-for-transcribers.html" target="_blank"><i class="fa-regular fa-circle-question"></i></a>
							<?php
							break;
						case 3: ?>
							<?php
