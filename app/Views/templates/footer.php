<?php $session = session(); ?>    
	...
	if ( $session->masquerade == 1 )
		...
		<?php
				...
				<a class="" title="Manage your Identity" href="<?=(base_url('identity/change_details_step2/0')) ?>"><i class="fa-solid fa-id-card"></i>MI</a>
				<a class="" title="Housekeeping" href="/housekeeping/index/0"><i class="fa-solid fa-warehouse"></i>House</a>
				<?php
