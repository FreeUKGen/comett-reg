	...
	<form action="<?php echo(base_url('identity/create_identity_step2')) ?>" method="post">
		<div class="form-group row">
			...
			<small id="userHelp" class="form-text text-muted col-2">This must be your <?php echo $session->current_project['project_name']; ?> user name.</small>
			...
			<small id="userHelp" class="form-text text-muted col-2">This must be your <?php echo $session->current_project['project_name']; ?> password.</small>
		</div>
		...
		<div class="form-group row">
			...
			<small id="userHelp" class="form-text text-muted col-2">This is required in order to submit transcriptions to <?php echo $session->current_project['project_name']; ?>.</small>
		...
		<br><br>
		<div class="row">
			<label for="create_freebmd_identity" class="col-8 pl-0">You don't have a <?php echo $session->current_project['project_name']; ?> Identity?</label>
			<a id="create_freebmd_identity" class="btn btn-outline-primary btn-sm col-4" href="https://www.freebmd.org.uk/Signup.html">
				<span>Start the <?php echo $session->current_project['project_name']; ?> registration process</span>
			</a>
		</div>
