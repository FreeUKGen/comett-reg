	...
	?>
		...
		<h2 class="heading inline"><?php echo $mode;?>File</h2><span class="ml-2"><?=' for '.$session->identity_userid.' in syndicate '.$session->syndicate_name ?></span>
	</div>

	<!-- data entry fields -->
	<section class="mb-3 mt-1 flex">
		<!-- assignment description -->
		<label id="ass_name_label">Description
			<input type="text" class="ml-1" id="ass_name" placeholder="Assignment Description">
		</label>
	</section>
				
	<section class="mb-3 flex">
		<!-- country -->	
		<label id="county_group_label" class="label">Country
			<select id="county_group" class="w14 block">
			</select>
		</label>

		<!-- County -->
		<label id="county_container" class="w14 ml-4">
			County
        	<select class="w14 block" id="county"></select>
    	</label>

	    <label id="chapman_label" for="chapman_code" class="ml-2 w8">Chapman Code
			<input type="text" size="3" id="chapman_code">
		</label>
    </section>

		
    <section id="place_container" class="flex mb-3">
        <label id="place_label" for="place" class="">Place
        	<select class="w14 block" id="place"></select>
		</label>

        <label id="church_label" class="w14 ml-4" for="church">Church
        <select id="church" class="w14 block"></select>
		</label>

        <label id="church_code_label" class="w8 ml-2"  for="church_code">Church Code
       	 <input type="text" size="3" id="church_code">
		</label>
    </section>

	<section id="register_container" class="mb-3">
        <label id="register_label">Register
			<select id="register" class="w14 block"></select>
		</label>
    </section>

    <section class="mb-3" id="source_inputs">
        <label id="source_label">Images Source
		<select class="w14 block" id="source"></select>
		</label>
    </section>

	<section id="doc_source_container" class="mb-3">
		<label id="doc_source_label">Document Source
			<select id="doc_source" class="w14 block"></select>
		</label>
	</section>

    <section id="credit_container" class="mb-3">
        <label id="credit_label">Credit To
        <input type='text' class="w14 block" id='credit' />
		</label>
    </section>
		
    <section id="doc_comment" class="mb-3 flex flex-end">
        <label id="doc_comment_label">Document Comments
        <textarea class="w30 block" id='comments'></textarea>
		</label>
		<a id="confirm" class="btn inline-block right submit hidden" title="Update Assignment">Confirm</a>
    </section>
